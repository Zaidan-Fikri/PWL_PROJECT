...
<div class="container mt-5">
    ...
    <div class="row justify-content-center align-items-center">
        <div class="card" style="width: 65rem;">
            ...
            @endif
            <form method="post" action="{{ route('barang_masuk.store') }}" id="myForm" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="Supplier" name="supplier" class="form-control" id="Supplier" ariadescribedby="Supplier" >
                </div>
                <div class="form-group">
